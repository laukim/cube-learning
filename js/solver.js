...
export const ALG_LIBRARY = [
  ...
  {
    group: "Beginner PLL · Corners",
    name: "T-perm",
    when: "Headlights on LEFT (or none → do once)",
    alg: "R U R' U' R' F R2 U' R' U' R U R' F'",
    tip: "Headlights LEFT. No headlights → same alg from any angle, then headlights appear. youtube.com/watch?v=RCPVu112HKg",
  },
  {
    group: "Beginner PLL · Edges",
    name: "U-perm",
    when: "Bar at BACK (or none → do once)",
    alg: "R2 U' R' U' R U R U R U' R",
    tip: "Bar at back. No bar → U-perm once to create one, then bar at back again. Mirror if wrong way.",
  },
  {
    ...
    tip: "Opposite good edges: do this once from anywhere → they become adjacent, then hold left+back and repeat. Same family as beginner U-perm.",
  },
  {
