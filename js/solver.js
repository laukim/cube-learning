...
export const ALG_LIBRARY = [
  ...
  {
    group: "2-look OLL · Cross",
    name: "Line (Cube Academy)",
    when: "Yellow line on U",
    alg: "F R U R' U' F'",
    tip: "Hold line horizontal. From cube.academy/2-look-oll-algs",
  },
  {
    group: "2-look OLL · Cross",
    name: "L shape (Cube Academy)",
    when: "Yellow L on U",
    alg: "f R U R' U' f'",
    tip: "Wide f. Hold L at 9-o’clock. From cube.academy/2-look-oll-algs",
  },
  {
    group: "2-look OLL · Finish",
    name: "Sune",
    when: "One corner oriented (fish)",
    alg: "R U R' U R U2 R'",
    tip: "Cube Academy Finish OLL",
  },
  {
    group: "2-look OLL · Finish",
    name: "Antisune",
  ...
  {
    group: "2-look OLL · Finish",
    name: "T / Bowtie / Headlights / H / Pi",
    when: "Other OCLL cases",
    alg: "(see OLL tab)",
    tip: "Open the OLL practice tab — hints name the case. Source: cube.academy/2-look-oll-algs",
  },
  {
    group: "2-look PLL · Corners",
    name: "Headlights",
    when: "Matching corner pair on one side",
    alg: "R U R' U' R' F R2 U' R' U' R U R' F'",
    tip: "Hold headlights at back. From cube.academy/2-look-pll-algs",
  },
  {
    group: "2-look PLL · Corners",
    name: "No headlights",
    when: "No matching corner pair",
    alg: "F R U' R' U' R U R' F' R U R' U' R' F R F'",
    tip: "Do once → headlights appear. From cube.academy/2-look-pll-algs",
  },
  {
    group: "2-look PLL · Edges",
    name: "Ua / Ub / H / Z",
    when: "After corners solved",
    alg: "(see PLL tab)",
    tip: "Bar at back → Ua or Ub. No bar → H or Z. Open PLL tab for live hints.",
  },
  {
    ...
    tip: "Opposite good edges: do this once from anywhere → they become adjacent, then hold left+back and repeat. Ub on PLL tab is the same family.",
  },
  {
