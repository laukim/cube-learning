...
export const ALG_LIBRARY = [
  ...
  {
    group: "Beginner OLL · Cross",
    name: "Cross (dot / L / line)",
    when: "After F2L — make yellow cross",
    alg: "F R U R' U' F'",
    tip: "Dot: any angle. L: back+left. Line: horizontal. youtube.com/watch?v=x6EoaxxbImI",
  },
  {
    group: "Beginner OLL · Finish",
    name: "Sune (all corner cases)",
    when: "Yellow cross done — twist corners",
    alg: "R U R' U R U2 R'",
    tip: "1 corner → bottom-left. 0 → no yellow on front. 2 adj → on right. 2 opp → top-left + bottom-right. Repeat.",
  },
  {
