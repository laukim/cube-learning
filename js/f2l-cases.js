/**
 * Standard F2L cases in CubeHead’s newer video order, practised as R then L.
 * IDs: 1R, 1L, 2R, 2L, … 41L. R = front-right (R/U). L = front-left (L/U).
 * https://www.youtube.com/watch?v=3tYj-9f4dA0
 *
 * Watch-along groups: easy inserts → disconnected on U (incl. white-up) →
 * corner in slot → edge in slot → connected on U → both in slot.
 */
...
const FR = [
  ...
  [21, "Edge in slot", "Solved edge, white up", "U' R' F R F' R U' R'"],
  [22, "Edge in slot", "Flipped edge, white up", "U R U' R' U R U' R' U R U' R'"],
  [23, "Edge in slot", "Solved edge, white left", "U' R U' R' U2 R U' R'"],
  [24, "Edge in slot", "Solved edge, white right", "U R U R' U2 R U R'"],
  [25, "Edge in slot", "Flipped edge, white left", "U' R U R' U F' U' F"],
  [26, "Edge in slot", "Flipped edge, white right", "U F' U' F U' R U R'"],
  [27, "Connected", "Flipped edge pair", "U' R U2 R' U F' U' F"],
  [28, "Connected", "White up, edge flipped", "R U' R' U R U' R' U2 R U' R'"],
  [29, "Connected", "White front, edge left", "R U' R' U R' F R F' R U' R'"],
  [30, "Connected", "White right, edge front", "U' R U' R' U R U R'"],
  [31, "Connected", "White up, matching", "R U R' U2 R U' R' U R U' R'"],
  [32, "Connected", "White up, matching (other)", "R U' R' U2 F' U' F"],
  [33, "Connected", "White right, edge back", "R U2 R' U' R U R'"],
  [34, "Connected", "White front, edge back", "F' U2 F U F' U' F"],
  [35, "Connected", "White up, edge right", "U R U' R' U' R U' R' U R U' R'"],
